...
export const PRODUCT_RELEASES: ProductRelease[] = [
  {
    ...
    date: '2026-09-16',
    title: 'AI 参谋助手邀请测试',
    summary: '新增可追溯的 AI 参谋助手，帮助受邀用户理解匹配结果，并围绕位次和院校专业继续提问。',
    features: [
      '受邀用户登录后，可从顶部“问参谋”进入 AI 问答',
      '支持按考生位次查找院校专业，并给出结构化参考建议',
      '匹配结果新增“为什么这档”，可解读具体院校专业的档位、历年位次和选科要求',
      '回答附带证据编号、注意事项和免责声明，相关依据可展开查看',
      '当前为邀请测试，AI 建议仅供志愿决策参考，不能替代招生章程和官方信息',
    ],
  },
  {
    version: '1.4.0',
